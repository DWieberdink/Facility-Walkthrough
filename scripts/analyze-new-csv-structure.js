...
// Check for new categories that might need special handling
console.log("\n=== POTENTIAL MULTI-ENTRY CATEGORIES ===")
const potentialMultiEntry = surveyCategories.filter(
  (cat) =>
    cat.toLowerCase().includes("classroom") ||
    cat.toLowerCase().includes("room") ||
    cat.toLowerCase().includes("space"),
)
potentialMultiEntry.forEach((category) => {
...
// Check for any "Close Out" category questions
