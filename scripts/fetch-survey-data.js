// Fetch and parse the CSV data from the new URL
...
console.log("Sample data:", surveyData.slice(0, 3))
console.log("Total questions:", surveyData.length)

// Log the new schema fields
console.log("Schema fields found:")
if (surveyData.length > 0) {
  console.log("Headers:", Object.keys(surveyData[0]))
  console.log("Sample scoreWeight:", surveyData[0].scoreWeight)
  console.log("Sample answerWeights:", surveyData[0].answerWeights)
}
